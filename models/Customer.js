...
const CustomerSchema = new mongoose.Schema(
  {
    ...
    // Test bookings
    testBookings: [TestBookingSchema],
  },
  { timestamps: true }
);
...
// Return JWT token
CustomerSchema.methods.createCustomerJwtToken = function() {
  return jwt.sign({ id: this._id }, process.env.CUSTOMER_SECRET, {
    expiresIn: process.env.CUSTOMER_EXPIRE,
  });
};
...
// Add a test booking
CustomerSchema.methods.addTestBooking = function (testId, testName) {
  this.testBookings.push({ testId, testName });
  return this.save();
};
